...
namespace SeleniumAdvance
{
    public class SubScriptionTest
    {
        ...
        public  void AddSubscriptionTest()
        {
            ...
            driver.FindElement(By.XPath("//input[@name='demo59703']")).SendKeys("Sagar");
            driver.FindElement(By.XPath("//input[@id='id2']")).SendKeys("Patil");
            driver.FindElement(By.XPath("//input[@id='id10']")).SendKeys("TestAssociate");
